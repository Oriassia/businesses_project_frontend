      ...
      >
        <div className="lg:w-[40em] mx-auto text-center">
          ...
          <input
            ...
            className="px-4 py-3 border border-pink-400 rounded-md focus:outline-none focus:border-pink-600 transition duration-300 placeholder-gray-400 bg-white text-gray-800 shadow-md hover:shadow-lg"
